              ...
              <tr *ngFor="let priority of priorities" class="matrix-row">
                ...
                <td *ngFor="let activity of activities" class="matrix-cell">
                  <div class="space-y-2 min-h-[60px]">
                    ...
                    >
                      <div *ngIf="inputsMap.get(action.id)" class="absolute left-1 top-[calc(50%+4px)] -translate-y-1/2 w-0 h-0 border-y-[6px] border-y-transparent border-l-[10px] border-l-indigo-500" title="Has incoming dependencies"></div>
                      ...
                      <div *ngIf="outputsMap.get(action.id)" class="absolute right-2 top-[calc(50%+4px)] -translate-y-1/2 w-0 h-0 border-y-[6px] border-y-transparent border-l-[10px] border-l-indigo-500" title="Is prerequisite for other actions"></div>
                    </div>
